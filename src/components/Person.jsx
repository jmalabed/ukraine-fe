const Person = (props) => {
  ...
  return (
    <div className="d-flex flex-row">
      <img
        src="data:image/png;base64,"
        alt="blank name"
        className="aboutImg"
        width="20%"
        height="20%"
      ...
      <div className="p-3">
        <div className="d-flex">
          <img
            ...
            height="25em"
          />
          <p className="">Sample Location{personObj.location}</p>
        </div>
        <h2 className="pb-2 mb-2">MyNameGoesHere</h2>
        <p>
